...
//                img.style.cssText += ';margin:' + (first.margin||0) +"px;" + 'border:' + (first.border||0) +"px solid #000";
            ...
            if (opt.length == 1) {
                ...
                str = '<img src="' + ci.src + '" ' + (ci._src ? ' _src="' + ci._src + '" ' : '') +
	                ...
	                (ci.type ? ' data-img-type="' + ci.type + '" ' : '') +
	                (ci.width && ci.width>0 ? ' data-width="' + ci.width + '" ' : '') +
	                (ci.height  && ci.height>0? ' data-height="' + ci.height + '" ' : '') +
	                (ci.ratio && ci.ratio>0 ? ' data-ratio="' + ci.ratio + '" ' : '') +
	                (ci.original ? ' data-original="' + ci.original + '" ' : '') +
